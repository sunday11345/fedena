...
ActiveRecord::Schema.define(:version => 20130110095412) do
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"is_active"=>nil, "course_id"=>nil, "is_deleted"=>nil, "name"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"exam_id"=>nil, "observable_id"=>nil, "student_id"=>nil, "observable_type"=>nil, "batch_id"=>nil}
